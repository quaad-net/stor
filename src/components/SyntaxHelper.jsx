        ...
        return(
            <>
                <div>
                    ...
                    <div>- Goes to but does not include location end.</div>
                    <h3>Code Query</h3>
                    <div style={{color: 'gold'}}>[Q]&nbsp;Code&nbsp;Code Code...</div>
                    <div>- Example&nbsp;=&gt;&nbsp;<span style={{color: 'gray'}}>22-12345 51-12345</span></div>
                    ...
                    <h3>Using Filter</h3>
                    <div>- Narrows results based on filter input and type selection. Returns records that contain an exact match.</div>
                    <br/>
                </div>
            </>
